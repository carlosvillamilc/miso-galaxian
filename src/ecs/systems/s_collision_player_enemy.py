...
def system_collision_player_enemy(world:esper.World, player_entity:int, elapsed_time:float, player_explosion_time:float):
    ...
    if player_explosion_time == 0 or time_difference >= 3:
        ...
        for enemy_entity, (c_s, c_t, c_te) in enemy_components:
            ...
            if enemy_rect.colliderect(p_rect):
                ...
                create_explosion(world, pygame.Vector2(p_t.pos.x - 10, p_t.pos.y - 10), 'player')
